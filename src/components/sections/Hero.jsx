...
import MotionDivRightToLeft from "../animation/MotionDivLeftToRight"
...
export default function HeroPersonImg({ appDownloadButtons }) {
  ...
  return (
    <>
      <div
        className="w-full bg-left desktop1:hidden bg-repeat bg-cover bg-bgSectionDark font-mainFont desktop1:pt-[45px]"
        id="home"
        style={{
